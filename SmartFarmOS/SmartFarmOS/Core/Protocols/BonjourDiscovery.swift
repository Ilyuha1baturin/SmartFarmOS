...
/// Протокол для обнаружения устройств через Bonjour/mDNS
public protocol BonjourDiscoveryProtocol: ObservableObject {
...
@MainActor
public final class BonjourDiscovery: BonjourDiscoveryProtocol {
